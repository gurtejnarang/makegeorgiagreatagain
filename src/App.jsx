...
const POLICIES = [
  ...
  },
  {
    ...
    stat: '430 Mi.',
    statSub: 'Columbus to the Gulf. God already gave us the river — time to build on it.',
    body: "The lower Chattahoochee already moves boats from the Gulf up to Columbus. That's the foundation. Strong leadership extends the navigable channel, cleans it up, deepens it where it counts, and builds the retail, restaurants, marinas, and family destinations that turn a river into a regional economy. Give Georgia kids and families a reason to spend their weekends right here at home.",
    bullets: [
      'Extend and improve the navigable channel from Columbus to the Gulf',
      'Develop marinas, boat launches, and water taxi infrastructure',
      'Build retail and restaurant corridors along the riverfront',
      'Drive tourism dollars into communities that have been overlooked',
      'Create the kind of family weekend destination that keeps money in Georgia',
    ],
  },
]
