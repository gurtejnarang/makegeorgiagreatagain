...
const POLICIES = [
  ...
  },
  {
    ...
    stat: '430 Mi.',
    statSub: 'God already gave us the river — time to build on it.',
    ...
    bullets: [
      ...
      'Develop marinas, boat launches, and water taxi infrastructure along the lower river',
      'Build restaurant, bar, and entertainment districts the entire length of the river',
      'Statewide water quality initiative — clean enough for kids and families to swim in',
      'Trails, riverfront parks, and recreation from the mountains to the Gulf',
      'Turn the Chattahoochee into a statewide economic asset every Georgian can enjoy',
    ],
  },
]
